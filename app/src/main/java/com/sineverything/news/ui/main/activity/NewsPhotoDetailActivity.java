...
import com.sineverything.news.ui.main.fragment.PhotoDetailFragment;
...
public class NewsPhotoDetailActivity extends BaseActivity {
    ...
    public void initView() {
        txtTitle.setText(R.string.news_photo_details);
        mNewsPhotoDetail = getIntent().getParcelableExtra(AppConstant.PHOTO_DETAIL);
        index = getIntent().getIntExtra(AppConstant.PHOTO_INDEX, 0);
    ...
    private void createFragment(NewsPhotoDetail newsPhotoDetail) {
        ...
        for (Picture picture : newsPhotoDetail.getPictures()) {
    ...
    public static void startAction(Context context, NewsPhotoDetail mNewsPhotoDetail, int index) {
        Intent intent = new Intent(context, NewsPhotoDetailActivity.class);
        intent.putExtra(AppConstant.PHOTO_DETAIL, mNewsPhotoDetail);
        intent.putExtra(AppConstant.PHOTO_INDEX, index);
        context.startActivity(intent);
    }
