...
public class SearchCommodityActivity extends BaseActivity {
    ...
    private void getSearchList() {
        ...
        searchHistory = UserManager.getSearchHistory(this);
    ...
    public void initView() {
        ...
        tagLayout.setOnTagClickListener(new TagFlowLayout.OnTagClickListener() {
            ...
            public boolean onTagClick(View view, int i, FlowLayout flowLayout) {
                ...
                CommodityActivity.startActionWithKeywords(mContext, dataSearchList.get(i));
        ...
        lisvSeatchResoult.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                CommodityActivity.startActionWithKeywords(mContext, dataSearchList.get(position));
    ...
    private void saveSearch(String msg){
        ...
        UserManager.saveSearchName(this, msg);
