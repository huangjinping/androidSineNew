...
package com.sineverything.news.comm.widget.progressbar;
...
public abstract class BaseRoundCornerProgressBar extends LinearLayout {
    ...
    public void setupStyleable(Context context, AttributeSet attrs) {
        ...
        int colorBackgroundDefault = context.getResources().getColor(R.color.transparent_quarter);
        colorBackground = typedArray.getColor(R.styleable.RoundCornerProgress_rcBackgroundColor, colorBackgroundDefault);
        int colorProgressDefault = context.getResources().getColor(R.color.btn_press_color);
        colorProgress = typedArray.getColor(R.styleable.RoundCornerProgress_rcProgressColor, colorProgressDefault);
        int colorSecondaryProgressDefault = context.getResources().getColor(R.color.btn_unpress_color);
