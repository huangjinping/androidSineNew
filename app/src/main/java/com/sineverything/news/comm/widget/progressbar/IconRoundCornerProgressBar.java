...
public class IconRoundCornerProgressBar extends BaseRoundCornerProgressBar implements View.OnClickListener {
    ...
    protected void initStyleable(Context context, AttributeSet attrs) {
        ...
        iconResource = typedArray.getResourceId(R.styleable.IconRoundCornerProgress_rcIconSrc, R.mipmap.icon);
        ...
        int colorIconBackgroundDefault = context.getResources().getColor(R.color.transparent);
