...
//    private static final String familyPhone = "[1-9](\\d{6,7})";
    ...
    // 匹配手机号码
    private static final String mobile = "((\\(\\d{2,3}\\))|(\\d{3}\\-))?(1[34578]\\d{9})";
    // 匹配网址
     ...
     * @return
     */
    public static boolean bigDecimal(String value) {
        try {
    ...
    public static Map<String, String> getURLRequestParam(String URL) {
    ...
    public static boolean verityPeriod(String period) {
